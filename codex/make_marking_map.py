...
def build() -> str:
    ...
    out = [
        ...
        "",
        "### The Topic Reference column IS the unit name (James, 2026-08-14)",
        "",
        "Put the unit's name from the table below straight into the Topic Reference",
        "cell, hyperlinked to its URL. **Do not invent a separate topic taxonomy.**",
        "",
        "> | Error | Correction | Topic Reference |",
        "> |---|---|---|",
        "> | a nice ~~wheather~~ | nice **weather** | [Countable and uncountable (A2)](" + SITE + "#a2_countable) |",
        "",
        "The old scheme — `Nouns & Determiners → Nouns: Uncountable and Always-Plural`",
        "— drifted badly: 8 of Martina's sheets used **30 distinct labels for about 15",
        "real topics**, with *Articles* appearing under three different spellings and",
        "two whole generations of naming. Label-equals-unit removes the drift at the",
        "source and makes the link automatic. Legacy sheets are translated by",
        "`codex/marking_topic_map.json`, guarded by `codex/check_marking_labels.py`.",
        "",
        "**If an error has no unit, leave the cell as plain text.** Do not link to",
        "something approximate. The blanks are the build queue.",
        "",
        "### Naming",
        "",
