...
| **B6** | Options stay on the teaching axis. *anybody / somebody / nobody* tests the quantifier; *anyone / anywhere / anything* tests the stem. A form pack offers forms of THIS word, not sibling verbs. If two prepositions are both right (*to me* / *for me*), do not put one on the answer and the other on the distractors — keep the same words, scramble only the order. | `a2_quantifiers` 2026-08-26; `a1_present_simple` 2026-08-29: *I ____ in an office* offered work / live / like. `a1_like_want_need` 2026-08-29: *He ____ a phone* must offer *needs / need*, not like / want / to. `b1_indirect_questions` 2026-08-30: *he got* vs *did he get* / *he get*, not *it costs*. `b1_word_order_fronting` 2026-08-30: *English is important to me* vs *Important for me is English* — *"both for and to are correct / keep same prepositions for all options"*. | `confirmed` |
