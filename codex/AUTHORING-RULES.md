...
| **C29** | A tense unit's card 0 has a **timeline** against tenses already taught. Do not put the new form later on the arrow — that reads as future. Present continuous is **present**, a short time at NOW, not a point to the right of *every day*. Labels are student English (*for a short time*), not *temporary*. | `a2_present_continuous` 2026-08-29: left-to-right arrow looked like the future; then *"temporary is not a beginner word"*. | `observed` |
