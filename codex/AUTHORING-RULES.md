...
| **C44** | If the bank drills a closed-class cousin as **the same job**, the intro names it as the same job. Do not gloss it with a neighbour meaning, and do not split the cousins into different rows on the map. | `b1_modals_speculation` 2026-08-30: *could* missing from the title and treated as past ability / polite — *"could is basically the same as may and might in most situations"*. | `observed` |
